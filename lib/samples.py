...
samples_dict['jfakeiso15'] = [i.replace('data15_13TeV', 'jfakeiso15') for i in samples_dict['data15']]
samples_dict['jfakeiso16'] = [i.replace('data16_13TeV', 'jfakeiso16') for i in samples_dict['data16']]
samples_dict['jfakeiso17'] = [i.replace('data17_13TeV', 'jfakeiso17') for i in samples_dict['data17']]
samples_dict['jfakeiso18'] = [i.replace('data18_13TeV', 'jfakeiso18') for i in samples_dict['data18']]

samples_dict['jfakeid15'] = [i.replace('data15_13TeV', 'jfakeid15') for i in samples_dict['data15']]
samples_dict['jfakeid16'] = [i.replace('data16_13TeV', 'jfakeid16') for i in samples_dict['data16']]
samples_dict['jfakeid17'] = [i.replace('data17_13TeV', 'jfakeid17') for i in samples_dict['data17']]
samples_dict['jfakeid18'] = [i.replace('data18_13TeV', 'jfakeid18') for i in samples_dict['data18']]

samples_dict['jfakeiso215'] = [i.replace('data15_13TeV', 'jfakeiso215') for i in samples_dict['data15']]
samples_dict['jfakeiso216'] = [i.replace('data16_13TeV', 'jfakeiso216') for i in samples_dict['data16']]
samples_dict['jfakeiso217'] = [i.replace('data17_13TeV', 'jfakeiso217') for i in samples_dict['data17']]
samples_dict['jfakeiso218'] = [i.replace('data18_13TeV', 'jfakeiso218') for i in samples_dict['data18']]

samples_dict['jfakeid215'] = [i.replace('data15_13TeV', 'jfakeid215') for i in samples_dict['data15']]
